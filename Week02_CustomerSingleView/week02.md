...
![lotusReport1](https://github.com/HikariJadeEmpire/AdvancedAnalytics-MADT8101/assets/118663358/5b4da01e-8f7a-4417-a16e-04d82a48f5da)
...
![lotusReport2](https://github.com/HikariJadeEmpire/AdvancedAnalytics-MADT8101/assets/118663358/409449aa-90b8-4c83-98a6-b99acf7fffb8)
...
![lotusReport3](https://github.com/HikariJadeEmpire/AdvancedAnalytics-MADT8101/assets/118663358/a23b9c47-f4f6-4646-9f00-5a1bf9ec3ad6)
...
กลุ่มถัดมาคือกลุ่มที่ 0 (กลุ่มสุดท้าย) <br>

![lotusReport4_Page_1](https://github.com/HikariJadeEmpire/AdvancedAnalytics-MADT8101/assets/118663358/17957303-0834-42e2-9a46-3e87d7b79145)
...
![lotusReport4_Page_2](https://github.com/HikariJadeEmpire/AdvancedAnalytics-MADT8101/assets/118663358/1e5b6c0b-ca3f-428a-ad3e-4685525168d3)

<br>

สำหรับการเปรียบเทียบ Cluster แต่ละกลุ่ม เราจะทำการเรียงลำดับตามอัตราการซื้อสินค้าจาก น้อย-มาก พบว่า :

1. กลุ่ม 1 :purple_circle: (สีม่วง) คือกลุ่มที่มักจะซื้อสินค้าประเภทของชำ และสินค้าประเภทที่ :x: ไม่ใช่อาหาร ซึ่งมักจะซื้อในจำนวนที่น้อย ไม่หลากหลาย แต่มาซื้อบ่อย
2. กลุ่ม 2 :large_orange_diamond: ( สีส้ม ) คือกลุ่มที่มักจะมีค่าที่เป็น XX คือระบุไม่ได้ :grey_question: และเป็นคนกลุ่มน้อย มาไม่บ่อย แต่ซื้อเยอะกว่ากลุ่ม 1 🟣
3. กลุ่ม 3 :large_blue_diamond: ( สีน้ำเงินเข้ม ) คือกลุ่มที่มาไม่บ่อย แต่เมื่อมาแล้วมักจะซื้อของหลายอย่าง และซื้อเยอะเต็มตะกร้า :shopping: และเป็นกลุ่มที่ชอบซื้อของราคาถูก :label:
4. กลุ่ม 0 :large_blue_circle: ( สีฟ้า ) คือกลุ่มที่ซื้อของแพง :gem: ซื้อเยอะที่สุด และซื้อบ่อย มักจะซื้อสินค้าประเภทของสด :cut_of_meat:
